...
let myOnCondition = function() {
  ...
  dialogDiv.innerHTML =
      ...
      '<img src = "https://giove.isti.cnr.it/demo/pat/src/img/event.jpeg">'+
      '<span>Punctual happening in a time frame</span>' +
      '<button class="pure-button" id="customDialogEvent">Event</button>' +
      '</div>' + 
      '<div class="select-condition">' +
      '<img src = "https://giove.isti.cnr.it/demo/pat/src/img/condition.jpeg">'+
      '<span>Extended state in a time frame</span>' +
